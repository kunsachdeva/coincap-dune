import fetchCryptoCurrency from "@/network/fetchCryptoCurrency";
...
export default async function Coin({
  ...
  const cryptoCurrency = await fetchCryptoCurrency(id);


  const isReducing = cryptoCurrency.changePercent24Hr[0] === '-'
  return (
<section className="bg-white dark:bg-gray-900">
    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">{cryptoCurrency.name}</h1>
            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">
              ${Number(cryptoCurrency.priceUsd).toFixed(2)}
              <span className={`m-4 text-sm text-${isReducing?"red":"green"}-800 font-bold`}>{Number(cryptoCurrency.changePercent24Hr).toFixed(2)}%</span>
            </p>
            <a href={cryptoCurrency.explorer || "#"} className="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                Explorer
        ...
        <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Volume 24H</h2>
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">${cryptoCurrency.volumeUsd24Hr}</p>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                ...
                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Supply</h2>
                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">{cryptoCurrency.supply}</p>
                <a href="#" className="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center">Read more
                    <svg className="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                    </svg>
